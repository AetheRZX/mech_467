...
hold on;
plot(output_x_low, output_y_low, 'b-', 'LineWidth', 1.5, 'DisplayName', 'Simulated Path (Low BW)');
plot(output_x_high, output_y_high, 'r-', 'LineWidth', 1.5, 'DisplayName', 'Simulated Path (High BW)');
plot(output_x_low, output_y_high, 'g-', 'LineWidth', 1.5, 'DisplayName', 'Simulated Path (Mismatched Dyn.)');
